...
class DPOTrainer(Trainer):
    ...
    def get_batch_metrics(
        ...
        #print("policy_chosen_logps: ", policy_chosen_logps.item())
        #print("policy_rejected_logps: ", policy_rejected_logps.item())
        
        with torch.no_grad():
            if self.ref_model is None:
                #print("inside self.ref_model is None")
        ...
        #print("reference_chosen_logps: ", reference_chosen_logps.item())
        #print("reference_rejected_logps: ", reference_rejected_logps.item())
