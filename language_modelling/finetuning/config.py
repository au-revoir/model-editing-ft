...
class ScriptArguments:
    ...
    #prompt_column: Optional[str] = field(default=None, metadata={"help": "select from  rewrite, paraphrase, neighborhood for finetuning"})
    rewrite_prompt: Optional[bool] = field(default=False),
    paraphrase_prompt: Optional[bool] = field(default=False),
    neighborhood_prompt: Optional[bool] = field(default=False),
    data_size: Optional[int] = field(default=None, metadata={"help": "choose the number of examples to be trained/evaluated from the dataset"}),
    step_multiplier: Optional[int] = field(default=None),
    ...
    max_steps: Optional[int] = field(default=160, metadata={"help": "max number of training steps"})
