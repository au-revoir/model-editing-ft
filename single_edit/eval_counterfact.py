...
def compute_counterfact_predictions(model, tokenizer, record):
    ...
    res = {"rewrite_success": rewrite_success, "paraphrase_success": paraphrase_success, "neighborhood_success": neighborhood_success, "rewrite_diff": rewrite_diff, "paraphrase_diff": paraphrase_diff, "neighborhood_diff": neighborhood_diff}
    return res
